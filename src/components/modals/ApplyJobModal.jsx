        ...
        <div className="rounded  w-[400px] md:w-[900px] space-y-8 bg-white p-10 absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 my-[180px]">
          ...
          <div>
            ...
            <div className="flex space-x-5">
              ...
              <Link href="/">
                <p className="text-blue-500">Edit resume</p>
              </Link>
            </div>
          </div>
          {/* //helllo */}
          <form onSubmit={handleSubmit}>
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="border  w-full h-[200px] px-3 py-3"
                name=""
                id=""
              ></textarea>
            </div>
            ...
            <div className="flex justify-center pt-10">
              <button
                type="submit"
                className="bg-blue-400 px-10 py-1 text-white"
              >
                Submit Application
              </button>
            </div>
