        ...
        <div className='py-10 lg:py-0'>
            <div className='lg:flex justify-between items-center px-5 lg:px-[200px] lg:py-10 py-2'>
                ...
                <div className='space-y-5 lg:py-10'>
                    <p className='text-5xl font-bold leading-tight'> <span className='text-slate-500'>CareerHub</span>  Discover <br /> Your <span className='text-blue-400 text-6xl '>Next</span> <span className='animate-pulse'>Chapter</span> </p>
